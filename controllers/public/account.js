    ...
    fetch(API + 'getUser', {
        ...
        if (request.ok) {
            ...
            request.json().then(function (response) {
                ...
                if (response.session) {
                        ...
                        <div class="navbar-fixed">
                            <nav class="black">
                                <div class="nav-wrapper">
                                    <a href="index.html" class="brand-logo"><img src="${SERVER}/images/icono.png" height="60"></a>
                    ...
                    header = `
                        <div class="navbar-fixed">
                            <nav class="black">
                                <div class="nav-wrapper">
                                    <a href="index.html" class="brand-logo"><img src="${SERVER}images/logob.png" height="60"></a>
                                    <a data-target="mobile" class="sidenav-trigger"><i class="material-icons">menu</i></a>
                                    <ul class="right hide-on-med-and-down">
                                        <li><a href="index.html"><i class="material-icons left">view_module</i>Catálogo</a></li>
                ...
                let images = ['parra.jpg', 'parra2.jpg', 'parra3.jpg', 'parra4.jpg'];
